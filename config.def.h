...
static const char *fonts[]                 = {"Iosevka Fixed:size=12"};
...
static uint32_t colors[][3]                = {
	...
	[SchemeSel]  = { 0xeeeeeeff, 0x54487aff, 0x54487aff },
...
static const char *menucmd[] = { "j4-dmenu-desktop", "--dmenu", "mew -i", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_ALT,   Key_h,          incgaps,       {.i = +1 } },
	{ MODKEY|WLR_MODIFIER_ALT,   Key_l,          incgaps,       {.i = -1 } },
	{ MODKEY|WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT,    Key_h,      incogaps,      {.i = +1 } },
	{ MODKEY|WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT,    Key_l,      incogaps,      {.i = -1 } },
	{ MODKEY|WLR_MODIFIER_ALT|WLR_MODIFIER_CTRL,     Key_h,      incigaps,      {.i = +1 } },
	{ MODKEY|WLR_MODIFIER_ALT|WLR_MODIFIER_CTRL,     Key_l,      incigaps,      {.i = -1 } },
	{ MODKEY|WLR_MODIFIER_ALT,   Key_0,          togglegaps,     {0} },
	{ MODKEY|WLR_MODIFIER_ALT|WLR_MODIFIER_SHIFT,    Key_0,defaultgaps,    {0} },
	...
	{ MODKEY|WLR_MODIFIER_ALT,   Key_y,          incohgaps,     {.i = +1 } },
	{ MODKEY|WLR_MODIFIER_ALT,   Key_o,          incohgaps,     {.i = -1 } },
    ...
    { 0, Key_XF86AudioRaiseVolume,  spawn,                       SHCMD("~/scripts/dwl/dwl-volume.sh up") },
    { 0, Key_XF86AudioLowerVolume,  spawn,                       SHCMD("~/scripts/dwl/dwl-volume.sh down") },
    { 0, Key_XF86AudioMute,         spawn,                       SHCMD("~/scripts/dwl/dwl-volume.sh mute") },
    { 0, Key_XF86AudioMicMute,      spawn,                       SHCMD("~/scripts/dwl/dwl-volume.sh mute-mic") },
